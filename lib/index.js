...
packer.gulp = function (program, config, callback) {
  ...
  gulp.task('watch', function () {
    ...
    if (program.watch) {
        ...
        watch((source.views.watch.length)?(source.views.watch):(source.views.src), function () {
          gulp.start('views:hbs:app');
        });
        watch((source.images.watch.length)?(source.images.watch):(source.images.src), function () {
          gulp.start('images:styles:app');
        });
        watch((source.components.watch.length)?(source.components.watch):(source.components.src), function () {
